...
public class InfiniteProgressPanel extends JComponent implements MouseListener {
    ...
    public void paintComponent(Graphics g) {
        if (started) {
            ...
            if (dimension != null) g2.fillRect(u, v, dimension.width, dimension.height);
    ...
    private Area[] buildTicker() {
        ...
        for (double i = 0.0; i < barsCount; i++) {
            ...
            AffineTransform toBorder = AffineTransform.getTranslateInstance(tx, ty);
    ...
    public void small() {
        ...
        v = 36;
        setSize(180, 120);
        dimension = new Dimension(124, 56);
    }
    ...
    private int w = 30;
    private int x = 6;
    private double tx = 45.0;
    private double ty = -6.0;
    private int u = 0;
    private int v = 0;
    private Area buildPrimitive() {

        Rectangle2D.Double body = new Rectangle2D.Double(x, 0, w, h);
        Ellipse2D.Double head = new Ellipse2D.Double(0, 0, h, h);
        Ellipse2D.Double tail = new Ellipse2D.Double(w, 0, h, h);
